...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("filterOption").onchange = function () {
        ...
        document.getElementById("filterCategoryDiv").style.display = "none";
        ...
        if (filterOption === "category") {
            document.getElementById("filterCategoryDiv").style.display = "block";
            // Xóa giá trị của combobox "filterSupplier"
    ...
    if (filterOption === "category") {
        document.getElementById("filterCategoryDiv").style.display = "block";
        document.getElementById("filterCategory").value = defaultCategoryValue;
    } else if (filterOption === "supplier") {
        document.getElementById("filterSupplierDiv").style.display = "block";
