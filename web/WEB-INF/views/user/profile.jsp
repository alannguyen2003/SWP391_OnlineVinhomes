...
>>>>>>> 7ecca9591c16c6e4b2c791c1fd7e4bedcbb9cab7
                </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-12"><label class="labels">Room</label><input type="text" class="form-control" placeholder="enter address line 1" value=""></div>
