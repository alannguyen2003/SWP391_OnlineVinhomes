            ...
            <div class="card card-raised mb-3">
                <div style="margin: 0px;"  class="card-body p-5">
                    ...
                    <div class="text-center">
                        ...
                        <label for="avatar" class="btn btn-primary1 mdc-ripple-upgraded" type="button">
                            Upload new image
                    ...
                    <c:if test="${user.roleID == 1}">
                        <div class="caption text-center">Enter your room number
                            <form action="<c:url value="/user/updateRoom.do" />">
                                ...
                                <input class="form-control1" type="text" name="room" placeholder="Room Number"/>
                                <button class="btn btn-primary1 mt-10" type="submit">Save</button>
                            </form>
                        </div>
                    </c:if>
                    <c:if test="${user.roleID == 1}">
                ...
                <div style="margin: 0px!important;" class="card-body p-5">
                    ...
                    <form method="post" action="<c:url value="/user/updateInfo.do" />">
                        ...
                        <div class="mb-4 form-group">
                            ...
                            <input class="w-100 form-control1" name="username" value="${user.name}">
                        </div>
                        ...
                        <div class="mb-4 form-group">
                            ...
                            <input class="w-100 form-control1" name="gender" value="${user.gender}">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <select name="bid" class="w-100 form-control1">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4">
                                    ...
                                    <input class="w-100 form-control1" name="phone" value="${user.phone}">
                                </div>
                            </div>
                        </div>
                        <input type="hidden" class="form-control1" name="aid" id="id" value="${user.AID}">       
                        <input id="avatar" name="avatar" type="file" accept="image/*" style="display: none" />
                        <input type="hidden" name="isAvaChange" value="false">
                        <!-- Save changes button-->
                        <div class="text-end"><button class="btn btn-primary1" name="op" value="comfirm" type="submit">Save changes</button></div>
                    </form>
