                            ...
                            <div class="services-two__single">
                                <div class="services-two__img-box">
                                    <div class="services-two__img">
                                        <img src="${pageContext.request.contextPath}/assets/images/services/services-${cid}-${o.serviceID}.jpg" alt="services-${cid}-${o.serviceID}" style="width: 370px; height: 267px;">
                                    </div>
